...
export const CUSTOS_DETALHADOS: Record<Destino, ItemCustoDetalhado[]> = {
  ...
  // Europa não-UE — placeholder (Suíça/Noruega seguem protocolo UE; Turquia exige RNATT)
  SUICA: ITENS_PADRAO_UE,
  NORUEGA: ITENS_PADRAO_UE,
  TURQUIA: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,
  ...
  COREIA_DO_SUL: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,
  SINGAPURA: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,

  // Oriente Médio — placeholder
  CATAR: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,
  ARABIA_SAUDITA: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,
  EMIRADOS_ARABES: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,
  ISRAEL: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,

  // Oceania — placeholder (rota indireta: custos reais são muito maiores)
  AUSTRALIA: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,
  NOVA_ZELANDIA: ITENS_ASIA_COM_SOROLOGIA_PLACEHOLDER,
};
