  ...
  return (
    <div className="min-h-screen w-full bg-bone">
      ...
      <footer className="border-t border-border bg-paper">
        <div className="max-w-5xl mx-auto px-6 py-8 text-[11px] text-muted flex flex-wrap items-center gap-x-4 gap-y-2 justify-between">
          <span className="font-mono">iPet Tecnologia LTDA · São Paulo, SP</span>
          <div className="flex gap-4">
            <Link href="/regras" className="hover:text-ink transition-colors">
              Regras por país
            </Link>
