  ...
  return (
    <div>
      ...
      <input
        ...
        className={
          className ??
          "w-full bg-surface border border-border text-navy rounded-xl px-4 py-3 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-navy/20 focus:border-navy transition-colors"
        }
      />
    </div>
  );
