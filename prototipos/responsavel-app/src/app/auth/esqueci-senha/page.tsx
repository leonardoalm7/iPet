    ...
    <div className="min-h-screen flex flex-col px-5 pt-14 pb-8">
      ...
      {enviado ? (
        ...
        <>
          ...
          {erro && (
            <div className="flex items-start gap-2.5 bg-red-100 border border-red-700/50 rounded-xl p-3 mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-navy hover:bg-navy-light disabled:bg-gray-200 disabled:text-gray-400 text-white font-semibold py-3.5 rounded-2xl transition-colors"
            >
