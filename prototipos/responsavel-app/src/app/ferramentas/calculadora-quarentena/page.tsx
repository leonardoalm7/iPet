...
const DESTINOS: DestinoInfo[] = [
  ...
  { slug: "uniao-europeia", nome: "União Europeia", bandeira: "🇪🇺", exigeMicrochip: true, exigeVacina: true, diasCarenciaVacina: 21, validadeVacinaAnos: 1, exigeSorologia: true, diasCarenciaSorologia: 90, valorMinimoSorologia: "≥0,5 UI/mL", exigeCVI: true, diasAntesCVI: 10, exigePermissaoImportacao: false },
