...
export const CUSTOS_POR_DESTINO: Record<Destino, ItemCustoBase[]> = {
  ...
  // América Latina (chip + vacina + CVI, taxa curta)
  COLOMBIA: [MICROCHIP, VACINA, CVI, TAXA_EMBARQUE_CURTO, CAIXA_IATA, SEGURO_PET],
  PERU: [MICROCHIP, VACINA, CVI, TAXA_EMBARQUE_CURTO, CAIXA_IATA, SEGURO_PET],
  PARAGUAI: [MICROCHIP, VACINA, CVI, TAXA_EMBARQUE_CURTO, CAIXA_IATA, SEGURO_PET],
  BOLIVIA: [VACINA, CVI, TAXA_EMBARQUE_CURTO, CAIXA_IATA, SEGURO_PET],
  EQUADOR: [MICROCHIP, VACINA, CVI, TAXA_EMBARQUE_CURTO, CAIXA_IATA, SEGURO_PET],
  PANAMA: [MICROCHIP, VACINA, CVI, PERMISSAO_IMPORTACAO, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET],
  COSTA_RICA: [MICROCHIP, VACINA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET],

  // Europa (chip + vacina + sorologia + CVI, taxa média)
  ALEMANHA: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  FRANCA: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  ESPANHA: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  ITALIA: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  HOLANDA: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  SUICA: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  NORUEGA: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_MEDIO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],

  // Oriente Médio (chip + vacina + sorologia + CVI + permissão, taxa longa)
  EMIRADOS_ARABES: [MICROCHIP, VACINA, SOROLOGIA, PERMISSAO_IMPORTACAO, CVI, TAXA_EMBARQUE_LONGO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  ISRAEL: [MICROCHIP, VACINA, SOROLOGIA, PERMISSAO_IMPORTACAO, CVI, TAXA_EMBARQUE_LONGO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],

  // Ásia (chip + vacina + sorologia + CVI, taxa longa)
  COREIA_DO_SUL: [MICROCHIP, VACINA, SOROLOGIA, CVI, TAXA_EMBARQUE_LONGO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
  SINGAPURA: [MICROCHIP, VACINA, SOROLOGIA, PERMISSAO_IMPORTACAO, TRADUCAO_JURAMENTADA, CVI, TAXA_EMBARQUE_LONGO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],

  // Oceania (chip + vacina + sorologia + CVI + permissão, taxa longa)
  NOVA_ZELANDIA: [MICROCHIP, VACINA, SOROLOGIA, PERMISSAO_IMPORTACAO, TRADUCAO_JURAMENTADA, CVI, TAXA_EMBARQUE_LONGO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],

  // África (chip + vacina + sorologia + CVI + permissão, taxa longa)
  AFRICA_DO_SUL: [MICROCHIP, VACINA, SOROLOGIA, PERMISSAO_IMPORTACAO, CVI, TAXA_EMBARQUE_LONGO, CAIXA_IATA, SEGURO_PET, HOTEL_PET],
};
